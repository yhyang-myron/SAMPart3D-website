// For Mesh / Part segments
var video_width = 800;
const VIDEO_ASPECT_RATIO = 1.0 / 1.0;
var display_level = 0;
var video_names = ["megan", "cannon", "cactus", "fighter", "tripo-rabbit", "tripo-lizard", "rodin-catapult", "rodin-dragon"];
...
$(() => {
  ...
  setInterval(() => {
    $(".image-compare").each((_index, parent) => {
      ...
      const newLeftVideo = newLeft * 800/video_width;
      video = videos[current_video_idx];

      // drawImage(image, sx, sy, sWidth, sHeight, dx, dy, dWidth, dHeight)
      ctx.drawImage(
        video, 
        0, 0, newLeftVideo, 800,
        0, 0, newLeft, video_width/VIDEO_ASPECT_RATIO
        );  // RGB
      ctx.drawImage(
        video,
        800*(display_level+1)+newLeftVideo, 0, 800-newLeftVideo, 800, newLeft, 
...
/* Switcher. */
// Contains logic for switching between different scales.
$(() => {
